...
public class ListAllVideoSegmentHandlerTest {
    ...
    @Test
    public void testListAllVideoSegmentHandler() {
        ListAllVideoSegmentHandler handler = new ListAllVideoSegmentHandler(s3Client);
